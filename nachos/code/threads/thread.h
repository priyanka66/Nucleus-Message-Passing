...
class Thread {
  ...
  public:
    ...
    MessageBuffer* removeMessage();
    bool  isMessageQueueEmpty();    
   
    bool getWaitMsg(){return waitMsg;}
    void setWaitMsg(bool flag) {this->waitMsg=flag;}
  
    map<int, int> sendBuffMap;
    bool getWaitAns(){return waitAns;}
    void setWaitAns(bool flag) {this->waitAns=flag;}
    int numMsgs = 0;
  private:
    ...
    bool waitMsg;
    bool waitAns;
    List<MessageBuffer *> *messageQueue;     
